...
export default class SoundButtons extends Phaser.GameObjects.Container {
	constructor(config) {
		...
		this.musicButton = new ToggleButton({ scene: this.scene, model: model, emitter: emitter, backKey: 'toggleBack', onIcon: 'musicOn', offIcon: 'musicOff', event: G.TOGGLE_MUSIC });
		this.sfxButton = new ToggleButton({ scene: this.scene, model: model, emitter: emitter, backKey: 'toggleBack', onIcon: 'sfxOn', offIcon: 'sfxOff', event: G.TOGGLE_SOUND });
